                    ...
                    <div class="card card-style mx-0 mb-3">
                        <div class="p-3">
                            ...
                            <h1 class="font-700 font-34 color-red-dark mb-0">
                                <?=$totalData = $database->countData('warga');?></h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-style mx-0 mb-3">
                        <div class="p-3">
                            ...
                            <h1 class="font-700 font-34 color-blue-dark mb-0">
                                <?=$totalDataWithCondition = $database->countData('warga', 'jk = "L"');?></h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-style mx-0 mb-3">
                        <div class="p-3">
                            ...
                            <h1 class="font-700 font-34 color-green-dark mb-0">
                                <?=$totalDataWithCondition = $database->countData('warga', 'jk = "P"');?></h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card ">
        <div class="content">
            ...
            <div class="row mb-0 text-center">
                ...
                <a href="dana-desa.php" class="col-3">
            ...
            <div class="splide__list">
                <div class="splide__slide">
                    <a href="#" class="card  bg-21" data-card-height="200">
                        <div class="card-top">
                            <span
                                class="badge float-end bg-blue-dark p-2 text-uppercase rounded-s m-2">Technology</span>
                        </div>
                ...
                <div class="splide__slide">
                    <a href="#" class="card  bg-28" data-card-height="200">
                        ...
                        <div class="card-bottom m-3">
                            ...
                            <p class="mb-0 color-white font-12 opacity-40 pt-1">Posted by Enabled - 2 Hours, 21 Minutes
                                Ago</p>
                        </div>
                        <div class="card-overlay bg-gradient opacity-90"></div>
                    </a>
                ...
                <div class="splide__slide">
                    <a href="#" class="card  bg-29" data-card-height="200">
                        ...
                        <div class="card-bottom m-3">
                            ...
                            <p class="mb-0 color-white font-12 opacity-40 pt-1">Posted by Enabled - 3 Hours, 37 Minutes
                                Ago</p>
                        </div>
                        <div class="card-overlay bg-gradient opacity-90"></div>
                    </a>
            ...
            <div class="splide__list">
                <div class="splide__slide">
                    <a href="berita-detail.html" class="mx-3">
                        <div class="card card-style me-0 mb-0" style="background-image: url(images/fitness/5m.jpg);"
                            data-card-height="250">
                            <div class="card-top p-2">
                                <span class="color-black bg-white px-2 py-1 rounded-xs font-11"><i
                                        class="fa fa-fire color-orange-dark pe-2"></i>495 KCal</span>
                            </div>
                            <div class="card-bottom p-2 px-3">
                                <h3 class="color-white line-height-s">Sprint Training</h3>
                                <span class="color-white font-10 opacity-60"><i
                                        class="fa fa-map-marker pe-2"></i>Outdoors - 15 min</span>
                            </div>
                ...
                <div class="splide__slide">
                    <a href="#" class="mx-3">
                        <div class="card card-style me-0 mb-0" style="background-image: url(images/fitness/8m.jpg);"
                            data-card-height="250">
                            <div class="card-top p-2">
                                <span class="color-black bg-white px-2 py-1 rounded-xs font-11"><i
                                        class="fa fa-fire color-orange-dark pe-2"></i>657 KCal</span>
                            </div>
                            <div class="card-bottom p-2 px-3">
                                <h3 class="color-white line-height-s">Resistance Band Squats</h3>
                                <span class="color-white font-10 opacity-60"><i class="fa fa-map-marker pe-2"></i>Indoor
                                    - 35 min</span>
                            </div>
                            <div class="card-overlay bg-gradient"></div>
                        </div>
                ...
                <div class="splide__slide">
                    <a href="#" class="mx-3">
                        <div class="card card-style me-0 mb-0" style="background-image: url(images/fitness/3m.jpg);"
                            data-card-height="250">
                            <div class="card-top p-2">
                                <span class="color-black bg-white px-2 py-1 rounded-xs font-11"><i
                                        class="fa fa-fire color-orange-dark pe-2"></i>457 KCal</span>
                            </div>
                            <div class="card-bottom p-2 px-3">
        ...
        <div class="row">
            <div class="col-6 pe-2">
                <a href="#" class="card card-style mx-0 mb-3">
                    ...
                    <div class="p-2">
                        <h4>Stay Hydrated</h4>
                        <p class="mb-0 mt-n1 opacity-70 line-height-s pt-1 font-11">For best results, drink at least 6
                            glasses of Water daily.</p>
                    </div>
                </a>
            </div>
            <div class="col-6 ps-2">
                <a href="#" class="card card-style mx-0 mb-3">
                    ...
                    <div class="p-2">
                        <h4>Eat Clean</h4>
                        <p class="mb-0 mt-n1 opacity-70 line-height-s pt-1 font-11">Stay away from processed foods. Eat
                            natural and clean.</p>
                    </div>
                </a>
            </div>
            <div class="col-6 pe-2">
                <a href="#" class="card card-style mx-0 mb-3">
                    ...
                    <div class="p-2">
                        ...
                        <p class="mb-0 mt-n1 opacity-70 line-height-s pt-1 font-11">Make a habbit of working out each
                            day and stick to it!</p>
                    </div>
                </a>
            </div>
            <div class="col-6 ps-2">
                <a href="#" class="card card-style mx-0 mb-3">
                    ...
                    <div class="p-2">
                        <h4>Focus on Form</h4>
                        <p class="mb-0 mt-n1 opacity-70 line-height-s pt-1 font-11">Form follows function. Focus on a
                            great feel, not weights.</p>
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="content">
        <a href="#">
            <div class="card rounded-sm bg-28" data-card-height="250">
                <div class="card-top">
                    <div class="badge text-uppercase px-3 py-2 bg-dark-dark m-3 rounded-m float-end"><i
                            class="fab fa-apple pe-2"></i>APPLE</div>
                </div>
...
<div id="tab-4" class="tab-content mt-5">
    ...
    <div class="content">
        <div class="input-style has-borders has-icon validate-field mb-2">
            <i class="fa fa-search"></i>
            <input type="text" class="form-control validate-name" id="searchInput"
                placeholder="Search by name or nickname" autofocus>
            <!-- <label for="form1" class="color-highlight">Name</label> -->
        </div>
    </div>
    <div class="card">
...
<div id="tab-5" class="tab-content mt-4">
    <div class="card ">
        <a href="profil.php" class="d-flex m-3">
            <div><img data-src="img/<?php echo tampilkanGambar($mahasiswa) ?>"
                    src="img/<?php echo tampilkanGambar($mahasiswa) ?>"
