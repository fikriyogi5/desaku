...
<div class="card">
    <div class="content">
        <div class="d-flex">
            <div>
                <p class="color-highlight font-600 mb-n1"><?php echo ($mhs['jenis_pekerjaan'] == "") ? "TIDAK BEKERJA" : $mhs['jenis_pekerjaan']; ?></p>
            ...
            <div class="ms-auto align-self-center">
                ...
                <?php
                                ...
                                ?>
                <img src="img/<?php echo tampilkanGambar($mahasiswa); ?>"
                    data-src="img/<?php echo tampilkanGambar($mahasiswa); ?>"
                    class="rounded-circle  preload-img entered loaded" width="80" height="80">
        ...
        <div class="row mb-3 mt-4">
            ...
            <h5 class="col-6 text-end font-14 "><?php echo $mhs['tempat_lahir']; ?>,
                <?php echo $mhs['tanggal_lahir']; ?></h5>
